...
/*  CHANGES FOR MOLLY - vedmed
 *
 *  1. I turned on "preserve $" option - may be bad for LaTeX though 
 *  
 *  2. The MathML ASCII coding strings can be turned on in 2 ways:
 *	-- inside "amath ... endamath" tags (no brackets)
 *	-- or for strings in backticks
 *
 *  As programming languages use backticks in abundance, I 
 *  __substituted__ in the whole script with a regex all 
 *  single backticks into DOBLE BACKTICKS.
 *
 * The authors of the script hardcoded backticks in very much,
 * and mechanically doubling them seems not to break thing
 *
 * This "double-backtick" seems safer for real-life applications.
 * Well, for now at least. Need to check/test/keep in mind these
 * hardcoded decisions not to get befuddled later
 *
 * It seems pretty damn hard to find good escapes which have not
 * yet been used one way or another in teh types of line noise
 * we keep for programming languages.
 *
 */
